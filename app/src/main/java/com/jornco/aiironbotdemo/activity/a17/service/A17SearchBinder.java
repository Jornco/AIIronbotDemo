...
import com.jornco.aiironbotdemo.activity.a17.A17SrvBinder;
...
public class A17SearchBinder extends ISearchIronbot.Stub implements IronbotSearcherCallback{
    ...
    public IBinder findService(String infoXml) throws RemoteException {
        ...
        return new A17SrvBinder(service);
    }
}
